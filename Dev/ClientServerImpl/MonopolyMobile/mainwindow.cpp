...
{
    ui->setupUi(this);
    setWindowTitle("Monopoly Mobile");
    resize(1280, 980);
    setMinimumSize(1280, 980);
    setMaximumSize(1280, 980);

    ui->Spieleraktivitaet_3->setGeometry(20, 20, 300, 700);
    ui->logHeaderLabel->setGeometry(16, 14, 260, 28);
    ui->textEdit_3->setGeometry(16, 50, 268, 632);
    ui->Brettspiel_2->setGeometry(400, 20, 800, 800);
    ui->Spieleranzeige_3->setGeometry(20, 760, 300, 150);
    ...
    ui->winWinnerLabel->setGeometry(30, 80, 580, 70);
    ui->saveCsvButton->setGeometry(30, 210, 580, 60);
    ui->playAgainButton->setGeometry(30, 290, 580, 60);

    ui->widget->setGeometry(320, 120, 640, 760);
    ui->label->setGeometry(30, 20, 580, 60);
    ui->label_2->setGeometry(30, 110, 420, 52);
    ui->playerNameInput->setGeometry(120, 116, 300, 40);
    ui->addPlayer->setGeometry(500, 112, 110, 52);
    ui->player1->setGeometry(30, 220, 580, 52);
    ui->player2->setGeometry(30, 284, 580, 52);
    ui->player3->setGeometry(30, 348, 580, 52);
    ui->player4->setGeometry(30, 412, 580, 52);
    ui->readyStartButton->setGeometry(30, 660, 580, 60);
    ui->importCSVbutton->setGeometry(20, 20, 220, 52);
    ui->ServerButton->setGeometry(20, 80, 220, 52);
